...
\iftoggle{soln}{%
  ...
  \lstinputlisting{../control_book_public_solutions/_B_pendulum/simulink/hw12/pendulumParamHW12.m}
}
...
\iftoggle{soln}{%
  ...
  \lstinputlisting{../control_book_public_solutions/_B_pendulum/simulink/hw12/pendulum_ctrl.m}
}
