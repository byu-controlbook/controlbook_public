...
class dataPlotterObserver:
    def __init__(self):
        ...
        self.handle.append(myPlot(self.ax[1], ylabel='y_dot', title='Data'))
    ...
    def update(self, t, x, x_hat, d, d_hat):
        ...
        self.y_history.append(x[0,0])
        self.y_dot_history.append(x[1,0])
        self.y_hat_history.append(x_hat[0,0])
        self.y_hat_dot_history.append(x_hat[1,0])
        self.d_history.append(d)
        self.d_hat_history.append(d_hat)

        # update the plots with associated histories
        self.handle[0].update(self.time_history, [self.y_history, self.y_hat_history])
        self.handle[1].update(self.time_history, [self.y_dot_history, self.y_hat_dot_history])
