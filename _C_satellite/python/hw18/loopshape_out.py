...
num_out = [P.sigma, 1.0]
den_out = [P.sigma*P.Jp, P.sigma*P.b+P.Jp,
           P.sigma*P.k+P.b+P10.kd_phi, P.k]
...
if __name__=="__main__":
    ...
    hf.add_spec_input_disturbance(gamma_din, omega_din,
                                  Plant, dB_flag)
